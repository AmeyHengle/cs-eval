...
class Metrics:
    ...
    def get_generation_metrics(self, df):
        ...
        pc_score_entailment, pc_score_contradiction = self.compute_pc_score(
            s1=hatespeech, s2=predictions_m2
        )

        print("-" * 50)
        print(f"Calculating CD Score")
        cd_score = self.compute_cd_score(
...
if __name__ == "__main__":
    ...
    input_df.to_csv(
        "/home/ameyh/counterspeech-EVAL/preds/results_combined.csv", index=False
    )
