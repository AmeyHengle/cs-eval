...
import os
from prompts import (
    relevance_score_prompt_gpt4,
    coherence_score_prompt_gpt4,
    aggressiveness_score_prompt_gpt4,
    suitableness_score_prompt_gpt4,
    common_input_prompt,
)
...
for i, row in tqdm(input_df.iterrows(), desc="Getting Predictions"):
    ...
    if i % 100 == 0:
        ...
        input_df.to_pickle(
            f"/home/amey/depository/cs-eval/predictions_rebuttal/{fname}.pkl"
        )
        input_df.to_csv(
            f"/home/amey/depository/cs-eval/predictions_rebuttal/{fname}.csv",
            index=False,
        )
        print("-" * 20)
...
input_df.to_csv(
    f"/home/amey/depository/cs-eval/predictions_rebuttal/{fname}.csv", index=False
)
